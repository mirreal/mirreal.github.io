...
[Git 客户端在 WebIDE 中的实现](https://blog.coding.net/blog/git-in-webide)
...
* 30 秒记录要点，在你经历的重要事件 http://www.jianshu.com/p/b5a128f53d79

* 丰田刹车事故，一万个全局变量的代码 http://blog.jobbole.com/100881/
